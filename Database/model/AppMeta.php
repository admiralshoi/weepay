...
class AppMeta extends \Database\Model {
    ...
    protected static array $requiredRows = [
        ...
        [
            "name" => "paymentPlans",
            "value" => '{"direct": {"enabled": true, "title": "Betal Nu", "caption": "Fuld betaling med det samme", "installments": 1, "start": "now"}, "pushed": {"enabled": true, "title": "Betal 1. i Måneden", "caption": "Udskyd betaling til næste måned", "installments": 1, "start": "first day of next month"}, "installments": {"enabled": true, "title": "Del i 4 Rater", "caption": "Betal over 90 dage", "installments": 4, "start": "now"}}',
            "type" => "array",
        ],
        [
            "name" => "resellerFee",
