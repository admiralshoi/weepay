...
{{template.email_footer}}',
        ...
        [
            ...
            "category" => "template",
            "subject" => null,
            "content" => "Hej {{user.first_name}}, din betaling på {{payment.formatted_amount}} til {{location.name}} forfalder om 5 dage ({{payment.due_date_formatted}}). Betal her: {{payment_link}}",
            "html_content" => null,
            "status" => "active",
            "created_by" => null,
        ],
        [
            ...
            "category" => "template",
            "subject" => null,
            "content" => "Hej {{user.first_name}}, din betaling på {{payment.formatted_amount}} til {{location.name}} forfalder i morgen! Betal nu: {{payment_link}}",
            "html_content" => null,
            "status" => "active",
            "created_by" => null,
        ],
...
{{template.email_footer}}',
        ...
        [
            ...
            "category" => "template",
            "subject" => null,
            "content" => "Nulstil din {{brand.name}} adgangskode her: {{reset_link}} (gyldig i 24 timer). Hvis dette ikke var dig, ignorer denne besked.",
            "html_content" => null,
            "status" => "active",
            "created_by" => null,
        ],
