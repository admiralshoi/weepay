...
$pageTitle = "Alle brugere";
$stats = $args->stats ?? (object)['totalUsers' => 0, 'totalConsumers' => 0, 'totalMerchants' => 0, 'totalActive' => 0, 'totalDeactivated' => 0, 'newSignups' => 0, 'newConsumers' => 0, 'newMerchants' => 0];
...
<script>
    ...
    activePage = "users";
    var adminUsersApiUrl = <?=json_encode(__url(Links::$api->admin->users->list))?>;
        ...
        <div class="flex-col-start" style="row-gap: 1.5rem;">
            ...
            <div class="flex-row-between flex-align-center w-100 flex-wrap" style="gap: 1rem;">
                <div class="flex-col-start">
                    <h1 class="mb-0 font-24 font-weight-bold">Alle brugere</h1>
                    <p class="mb-0 font-14 color-gray"><span id="users-total-count"><?=number_format($stats->totalUsers)?></span> brugere i alt</p>
                </div>
                <div class="flex-row-end flex-align-center flex-wrap" style="gap: .5rem;">
                    <a href="<?=__url(Links::$admin->panelUsers)?>" class="btn-v2 action-btn">
                        ...
                        <div class="card-body">
                            <div class="flex-row-between-center flex-nowrap g-075">
                                <div class="flex-col-start rg-025 flex-1 min-width-0">
                                    <p class="mb-0 font-12 color-gray text-wrap">Total brugere</p>
                                    <p class="mb-0 font-18 font-weight-bold"><?=number_format($stats->totalUsers)?></p>
                                </div>
                ...
                <div class="col-6 col-md-4 d-flex">
                    <div class="card border-radius-10px w-100">
                        <div class="card-body">
                            <div class="flex-row-between-center flex-nowrap g-075">
                                <div class="flex-col-start rg-025 flex-1 min-width-0">
                                    <p class="mb-0 font-12 color-gray text-wrap">Forbrugere</p>
                                ...
                                <div style="width: 40px; height: 40px; min-width: 40px;" class="bg-green border-radius-10px flex-row-center-center">
                                    <i class="mdi mdi-account color-white font-22"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-6 col-md-4 d-flex">
                    <div class="card border-radius-10px w-100">
                        <div class="card-body">
                            <div class="flex-row-between-center flex-nowrap g-075">
                                <div class="flex-col-start rg-025 flex-1 min-width-0">
                                    <p class="mb-0 font-12 color-gray text-wrap">Forhandlere</p>
                ...
                <div class="card-body">
                    <div class="flex-row-between-center flex-nowrap mb-3" style="column-gap: .5rem;">
                        <div class="flex-row-start flex-align-center flex-nowrap" style="column-gap: .5rem;">
                            ...
                            <p class="mb-0 font-16 font-weight-bold">Nye tilmeldinger over tid</p>
                        </div>
                ...
                <div class="card-body py-3">
                    <div class="flex-row-between flex-align-center flex-wrap" style="gap: .75rem;">
                        <div class="flex-row-start flex-align-center flex-wrap" style="gap: .5rem;">
                            <input type="text" class="form-field-v2" id="users-search" placeholder="Søg efter navn, email eller telefon..." style="min-width: 250px;">
                            <select class="form-select-v2" id="users-filter-role" style="min-width: 150px;">
                                <option value="all" selected>Alle roller</option>
                                <option value="1">Forbruger</option>
                                <option value="2">Forhandler</option>
                                <option value="8">Admin</option>
                                <option value="9">Superadmin</option>
                            </select>
                            <select class="form-select-v2" id="users-filter-status" style="min-width: 130px;">
                        ...
                        <div class="flex-row-end flex-align-center flex-wrap" style="gap: .5rem;">
                            <select class="form-select-v2" id="users-sort" style="min-width: 150px;">
                            ...
                            <select class="form-select-v2" id="users-per-page" style="min-width: 80px;">
            ...
            <div class="card border-radius-10px">
                <div class="card-body p-0">
                        ...
                        <table class="table table-hover mb-0" id="users-table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="font-12 font-weight-medium color-gray text-uppercase">Rolle</th>
                    ...
                    <!-- No results message -->
                    <div id="users-no-results" class="d-none flex-col-center flex-align-center py-5">
                        <i class="mdi mdi-account-search-outline font-50 color-gray"></i>
                        <p class="mb-0 font-16 color-gray mt-2">Ingen brugere fundet</p>
                    </div>
                </div>

                <div class="card-footer bg-white border-top" id="users-pagination-footer">
                    <div class="flex-row-between flex-align-center">
                        <p class="mb-0 font-13 color-gray">
                            Viser <span id="users-showing-start">0</span> - <span id="users-showing-end">0</span> af <span id="users-total">0</span> brugere
                        </p>
                        <nav>
...
<script>
    ...
    var signupsChartOptions = {
        series: [{
            name: 'Total',
            type: 'area',
            data: dailySignups.map(d => d.total)
        }, {
            name: 'Forbrugere',
            type: 'line',
            data: dailySignups.map(d => d.consumers)
        }, {
            name: 'Forhandlere',
            type: 'line',
            data: dailySignups.map(d => d.merchants)
        }],
        chart: {
            height: 300,
            type: 'line',
