    ...
    <div class="page-inner-content">
        <div class="flex-col-start" style="row-gap: 1.5rem;">
            ...
            <div class="flex-col-start">
                <h1 class="mb-0 font-24 font-weight-bold">Kommende betalinger</h1>
                <p class="mb-0 font-14 color-gray"><span id="payments-total-count">0</span> kommende betalinger</p>
            </div>
            ...
            <div class="card border-radius-10px">
                <div class="card-body p-0">
                                ...
                                <tr id="payments-loading-row">
                                    <td colspan="7" class="text-center py-4">
                                        <div class="flex-col-center flex-align-center">
                                            ...
                                            <p class="color-gray mt-2 mb-0">Indlæser kommende betalinger...</p>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <div id="payments-no-results" class="d-none flex-col-center flex-align-center py-5">
                        ...
                        <p class="mb-0 font-16 color-gray mt-2">Ingen kommende betalinger</p>
                    </div>
                </div>
