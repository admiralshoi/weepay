    ...
    <div class="page-inner-content">
        <div class="flex-col-start" style="row-gap: 1.5rem;">
            ...
            <div class="flex-col-start">
                <h1 class="mb-0 font-24 font-weight-bold">Betalinger</h1>
                <p class="mb-0 font-14 color-gray"><span id="payments-total-count">0</span> betalinger i alt</p>
            </div>
            ...
            <div class="card border-radius-10px">
                <div class="card-body p-0">
                        ...
                        <table class="table table-hover mb-0" id="payments-table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="font-12 font-weight-medium color-gray text-uppercase">Betalt</th>
                    ...
                    <div id="payments-no-results" class="d-none flex-col-center flex-align-center py-5">
                        <i class="mdi mdi-credit-card-off font-50 color-gray"></i>
                        <p class="mb-0 font-16 color-gray mt-2">Ingen betalinger fundet</p>
                    </div>
                </div>
