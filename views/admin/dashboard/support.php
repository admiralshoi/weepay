...
$pageTitle = "Support";
$stats = $args->stats ?? (object)['openTickets' => 0, 'pendingTickets' => 0, 'resolvedTickets' => 0, 'totalTickets' => 0];
                        ...
                        <div class="card-body">
                            <div class="flex-row-between-center flex-nowrap g-075">
                                <div class="flex-col-start rg-025 flex-1 min-width-0">
                                    ...
                                    <p class="mb-0 font-18 font-weight-bold"><?=number_format($stats->openTickets)?></p>
                                </div>
                ...
                <div class="col-6 col-lg-3 d-flex">
                    <div class="card border-radius-10px w-100">
                        <div class="card-body">
                            <div class="flex-row-between-center flex-nowrap g-075">
                                <div class="flex-col-start rg-025 flex-1 min-width-0">
                                    <p class="mb-0 font-12 color-gray text-wrap">Afventer svar</p>
                                    <p class="mb-0 font-18 font-weight-bold"><?=number_format($stats->pendingTickets)?></p>
                                </div>
                ...
                <div class="col-6 col-lg-3 d-flex">
                    <div class="card border-radius-10px w-100">
                        <div class="card-body">
                            <div class="flex-row-between-center flex-nowrap g-075">
                                <div class="flex-col-start rg-025 flex-1 min-width-0">
                                    <p class="mb-0 font-12 color-gray text-wrap">Løste sager</p>
                                    <p class="mb-0 font-18 font-weight-bold"><?=number_format($stats->resolvedTickets)?></p>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="flex-row-between-center flex-nowrap g-075">
                                <div class="flex-col-start rg-025 flex-1 min-width-0">
                                    ...
                                    <p class="mb-0 font-18 font-weight-bold"><?=number_format($stats->totalTickets)?></p>
                                </div>
                                <div style="width: 40px; height: 40px; min-width: 40px;" class="bg-blue border-radius-10px flex-row-center-center">
            ...
            <div class="card border-radius-10px">
                <div class="card-body">
                    ...
                    <div class="flex-col-center flex-align-center py-5">
                        <i class="mdi mdi-lifebuoy font-50 color-gray"></i>
                        <p class="mb-0 font-16 color-gray mt-2">Ingen support sager</p>
                        <p class="mb-0 font-14 color-gray">Support ticket systemet er klar til brug.</p>
                    </div>
                    <?php else: ?>
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            <thead>
                                <tr>
                                    <th class="font-12 font-weight-medium color-gray text-uppercase">Sag ID</th>
