...
<div class="page-content home">
    ...
    <div class="flex-row-between flex-align-center flex-wrap" style="column-gap: .75rem; row-gap: .5rem;">
        <div class="flex-col-start">
            ...
            <p class="mb-0 font-16 font-weight-medium color-gray">Oversigt over alle planlagte betalinger</p>
        </div>
            ...
            <div class="card border-radius-10px">
                <div class="card-body">
                    <div class="flex-row-start flex-align-center flex-nowrap mb-3" style="column-gap: .5rem;">
                        <i class="mdi mdi-credit-card-clock-outline font-18 color-blue"></i>
                        <p class="mb-0 font-22 font-weight-bold">Planlagte Betalinger</p>
                    </div>
                            ...
                            <?php if($args->payments->count() > 0): ?>
                                <?php foreach ($args->payments->list() as $payment): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class="mb-0 font-12 font-weight-bold"><?=number_format($payment->amount, 2)?> <?=currencySymbol($payment->currency)?></p>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="action-box font-12">Planlagt</span>
                                        </td>
                                        <td>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="8" class="text-center">
                                        <p class="mb-0 color-gray font-14 py-3">Ingen udestående betalinger fundet</p>
                                    </td>
                                </tr>
                            <?php endif; ?>
                            </tbody>
