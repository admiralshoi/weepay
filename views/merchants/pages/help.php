...
<div class="page-content">
    ...
    <div class="row" style="row-gap: 1.5rem;">
            ...
            <a href="<?=__url(Links::$faq->merchant)?>" class="card border-radius-10px h-100 text-decoration-none hover-shadow" style="transition: box-shadow 0.2s, transform 0.2s;">
                <div class="card-body p-4">
                    <div class="flex-col-start h-100">
                        ...
                        <p class="font-14 color-gray mb-3 flex-grow-1">Find svar på de mest almindelige spørgsmål om WeePay for forhandlere, opsætning, betalinger og meget mere.</p>
                        <div class="flex-row-start flex-align-center" style="gap: .5rem;">
        ...
        <!-- Support Card -->
        <div class="col-12 col-md-6">
            <a href="<?=__url(Links::$merchant->support)?>" class="card border-radius-10px h-100 text-decoration-none hover-shadow" style="transition: box-shadow 0.2s, transform 0.2s;">
                <div class="card-body p-4">
                    <div class="flex-col-start h-100">
