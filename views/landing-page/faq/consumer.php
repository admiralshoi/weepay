...
<div class="page-content">
    <div class="faq-page">
        <div class="faq-header">
            ...
            <p>Find svar på de mest almindelige spørgsmål om WeePay</p>
        </div>

        <div class="faq-nav">
            <a href="<?=__url(Links::$faq->consumer)?>" class="active">For forbrugere</a>
            <a href="<?=__url(Links::$faq->merchant)?>">For forhandlere</a>
        </div>
