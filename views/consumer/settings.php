        ...
        <div class="col-12 col-lg-8">
            ...
            <div class="card border-radius-10px mb-4">
                <div class="card-body">
                    ...
                    <div class="alert alert-info mb-3">
                        <i class="mdi mdi-information-outline"></i>
                        Som forbruger er 2FA påkrævet og kan ikke deaktiveres for din sikkerhed.
                    </div>
                                ...
                                <div class="flex-row-start flex-align-center" style="column-gap: .75rem;">
                                    <label class="form-switch">
                                        <input type="checkbox" id="twoFactorEnabled" name="two_factor_enabled"
                                            <?=($authLocal && $authLocal->{'2fa'} == 1) ? 'checked' : ''?> disabled>
                                        <i></i>
                                    </label>
                                    <span class="font-14">2FA Aktiveret <span class="badge bg-success ms-2">Påkrævet</span></span>
                                </div>
                            </div>

                            <div class="col-12 col-md-6 mb-3">
                                <label class="form-label font-14 font-weight-medium">2FA Metode</label>
                                <select class="form-select-v2" name="two_factor_method" id="twoFactorMethod" <?=!$authLocal || $authLocal->{'2fa'} != 1 ? 'disabled' : ''?>>
        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="card border-radius-10px">
                <div class="card-body">
                    ...
                    <a href="<?=__url(Links::$consumer->support)?>" class="btn-v2 trans-btn w-100">
