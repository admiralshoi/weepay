...
class Oicd {
    ...
    public string $callbackAuthenticate = "auth/user/verify";
    public string $preAuthUrl = "auth/user/preauth/{id}";
    public function generatePreAuthUrl(string $id): string { return str_replace("{id}", $id, $this->preAuthUrl); }
