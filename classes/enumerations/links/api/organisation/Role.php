...
class Role {
    ...
    public string $create = 'api/organisations/roles';
    public string $rename = 'api/organisations/roles/name';
    public string $delete = 'api/organisations/roles';
    public string $permissions = 'api/organisations/roles/permissions';
