/**
 * Admin Past Due Payments Table - Backend Pagination, Search, Filter, and Sort
 * Uses server-side pagination for scalability
 */
const AdminPaymentsPastDuePagination = (function() {
    // State
    let currentPage = 1;
    let perPage = 25;
    let searchTerm = '';
    ...
    async function fetchPayments() {
        ...
        try {
            const params = {
                ...
                status: 'PAST_DUE', // Only past due payments
            };
            ...
            <tr>
                <td colspan="7" class="text-center py-4">
                    <div class="flex-col-center flex-align-center">
                        ...
                        <button class="btn-v2 mute-btn mt-2" onclick="AdminPaymentsPastDuePagination.refresh()">Prøv igen</button>
                    </div>
                </td>
            </tr>
        `);
            ...
            <tr>
                <td>
                    <div class="flex-row-start flex-align-center" style="gap: .75rem;">
                        <div class="square-40 bg-danger-light border-radius-8px flex-row-center-center">
                            <i class="mdi mdi-alert font-20 color-danger"></i>
                        </div>
...
$(document).ready(function() {
    AdminPaymentsPastDuePagination.init();
});
